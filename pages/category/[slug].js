...
export async function getStaticProps({ params }) {
  ...
  return {
    ...
    revalidate: 3600, // safe default; prebuild + occasional refresh
  }
}
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={`Learn ${categoryName} on ehelp.tv: popular how-to guides and tutorials.`} />
